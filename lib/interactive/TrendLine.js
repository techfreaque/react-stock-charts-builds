...
var _EachTrendLine = _interopRequireDefault(require("./wrapper/EachTrendLine"));
...
var TrendLine = /*#__PURE__*/function (_Component) {
  ...
  function TrendLine(props) {
    ...
    _this.getSelectionState = (0, _utils2.isHoverForInteractiveType)("trends").bind(_assertThisInitialized(_this));
    _this.state = {};
    _this.nodes = [];
    return _this;
  }
  ...
  _createClass(TrendLine, [{
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          currentPositionstrokeOpacity = _this$props4.currentPositionstrokeOpacity,
          currentPositionStrokeWidth = _this$props4.currentPositionStrokeWidth;
      var _this$props5 = this.props,
          hoverText = _this$props5.hoverText,
          trends = _this$props5.trends;
      var _this$state = this.state,
          current = _this$state.current,
          override = _this$state.override;
      var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end) ? /*#__PURE__*/_react["default"].createElement(_StraightLine["default"], {
        type: type,
        noHover: true,
      ...
      return /*#__PURE__*/_react["default"].createElement("g", null, trends.map(function (each, idx) {
        var eachAppearance = (0, _utils.isDefined)(each.appearance) ? _objectSpread(_objectSpread({}, appearance), each.appearance) : appearance;

        var hoverTextWithDefault = _objectSpread(_objectSpread({}, TrendLine.defaultProps.hoverText), hoverText);

        return /*#__PURE__*/_react["default"].createElement(_EachTrendLine["default"], {
          key: idx,
...
TrendLine.propTypes = {
  ...
  currentPositionstrokeOpacity: _propTypes["default"].number,
  ...
  trends: _propTypes["default"].array.isRequired,

...
var _AreaSeries = _interopRequireDefault(require("./AreaSeries"));
...
var AlternatingFillAreaSeries = /*#__PURE__*/function (_Component) {
  ...
  function AlternatingFillAreaSeries(props) {
    ...
    _this.topClip = _this.topClip.bind(_assertThisInitialized(_this));
    _this.bottomClip = _this.bottomClip.bind(_assertThisInitialized(_this));
    _this.baseAt = _this.baseAt.bind(_assertThisInitialized(_this));
    var id1 = String(Math.round(Math.random() * 10000 * 10000));
    _this.clipPathId1 = "alternating-area-clip-".concat(id1);
    var id2 = String(Math.round(Math.random() * 10000 * 10000));
    _this.clipPathId2 = "alternating-area-clip-".concat(id2);
    return _this;
  }
  ...
  _createClass(AlternatingFillAreaSeries, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("g", {
        className: className
      }, /*#__PURE__*/_react["default"].createElement(_SVGComponent["default"], null, this.renderClip), /*#__PURE__*/_react["default"].createElement(_AreaSeries["default"], {
        style: style1,
      ...
      }), /*#__PURE__*/_react["default"].createElement(_AreaSeries["default"], {
        style: style2,
...
AlternatingFillAreaSeries.propTypes = {
  ...
  strokeOpacity: _propTypes["default"].shape({
    top: _propTypes["default"].number,
    bottom: _propTypes["default"].number
  }),
  ...
  fillOpacity: _propTypes["default"].shape({
    top: _propTypes["default"].number,
    bottom: _propTypes["default"].number
  }),
  ...
  baseAt: _propTypes["default"].number.isRequired,
...
var _default = AlternatingFillAreaSeries;

...
var StochasticSeries = /*#__PURE__*/function (_Component) {
  _inherits(StochasticSeries, _Component);

  var _super = _createSuper(StochasticSeries);
  ...
  function StochasticSeries(props) {
    ...
    _this.yAccessorForD = _this.yAccessorForD.bind(_assertThisInitialized(_this));
    _this.yAccessorForK = _this.yAccessorForK.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(StochasticSeries, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          refLineOpacity = _this$props.refLineOpacity;
...
StochasticSeries.propTypes = {
  ...
  refLineOpacity: _propTypes["default"].number.isRequired
};

...
var GroupedBarSeries = /*#__PURE__*/function (_Component) {
  _inherits(GroupedBarSeries, _Component);

  var _super = _createSuper(GroupedBarSeries);
...
GroupedBarSeries.defaultProps = _objectSpread(_objectSpread({}, _StackedBarSeries["default"].defaultProps), {}, {
  widthRatio: 0.8,
  spaceBetweenBar: 5
});

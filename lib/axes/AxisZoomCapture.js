...
var AxisZoomCapture = /*#__PURE__*/function (_Component) {
  ...
  function AxisZoomCapture(props) {
    ...
    _this.handleDragStartMouse = _this.handleDragStartMouse.bind(_assertThisInitialized(_this));
    _this.handleDragStartTouch = _this.handleDragStartTouch.bind(_assertThisInitialized(_this));
  ...
  _createClass(AxisZoomCapture, [{
    ...
    value: function handleDragStartMouse(e) {
      ...
      var _this$props = this.props,
          ...
          getMoreProps = _this$props.getMoreProps;
    ...
    value: function handleDrag() {
      ...
      var _this$props3 = this.props,
          getMouseDelta = _this$props3.getMouseDelta,
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("rect", {
        className: "react-stockcharts-enable-interaction ".concat(cursor, " ").concat(className),
        ref: this.saveNode,
        x: bg.x,
        y: bg.y,
        opacity: 0,
...
AxisZoomCapture.propTypes = {
  ...
  zoomCursorClassName: _propTypes["default"].string.isRequired,
  getMoreProps: _propTypes["default"].func.isRequired,

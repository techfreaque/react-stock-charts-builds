...
var SvgPathAnnotation = /*#__PURE__*/function (_Component) {
  _inherits(SvgPathAnnotation, _Component);

  var _super = _createSuper(SvgPathAnnotation);
  ...
  _createClass(SvgPathAnnotation, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react["default"].createElement("title", null, tooltip), /*#__PURE__*/_react["default"].createElement("path", {
        d: path({
          x: x,
          y: y
        }),
...
SvgPathAnnotation.propTypes = {
  ...
  path: _propTypes["default"].func.isRequired,
...
var _default = SvgPathAnnotation;
